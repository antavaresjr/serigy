...
<div class="container">
  <h1>Enviar VIPs CSV</h1>
  <div class="form-container">
    <p>Formato: Nome;ip_publico;ip_privado;tcp/udp;port_ext;port_int</p>
    <form action="/cgi-bin/vip_csv.cgi" method="post" enctype="multipart/form-data">
