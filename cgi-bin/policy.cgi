...
<div class="container">
  <h1>Enviar Policy CSV</h1>
  <div class="form-container">
    <p>Formato: Name;srcint;dstint;srcaddr;accept|deny;dstaddr;flow|proxy;</p>
    <form action="/cgi-bin/policy_csv.cgi" method="post" enctype="multipart/form-data">
