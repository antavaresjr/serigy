...
<div class="container">
  <h1>Enviar Static Routes CSV</h1>
  <div class="form-container">
    <p>Formato: default=yes|no;dst_address;gateway;interface</p>
    <form action="/cgi-bin/routes_csv.cgi" method="post" enctype="multipart/form-data">
