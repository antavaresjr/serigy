...
<div class="container">
  <h1>Enviar Interfaces CSV</h1>
  <div class="form-container">
    <p>Formato: Nome;0.0.0.0/0;type;interface;vlan_id;dhcp</p>
    <form action="/cgi-bin/interfaces_csv.cgi" method="post" enctype="multipart/form-data">
