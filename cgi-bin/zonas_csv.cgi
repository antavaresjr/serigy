...
awk -F';' '{
    ...
    printf "    next\n"
    printf "end\n"
}' "$TEMP_FILE" > "$UPLOAD_DIR/zones_file.txt"

# Ajusta as permissões do arquivo
chmod 644 "$UPLOAD_DIR/zones_file.txt"

# Remove o arquivo temporário
rm "$TEMP_FILE"

# Define o conteúdo a ser exibido no <textarea>
TEXTAREA_CONTENT=$(cat "$UPLOAD_DIR/zones_file.txt")
...
echo "<p><a href='/uploads/zones_file.txt' download='zones_file.txt'>Baixar arquivo</a></p>"
